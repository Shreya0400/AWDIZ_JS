...
//     }
//   }
//   CheckNumberIsEvenOrOdd(286);
  
  // Array
  
  // [data, data, data];
  
  // var students = ["Rahul", "Raj", "Mohan"];
  ...
  // Q. Print numbers from 1 to 10, by using for loop.
console.log("Printing numbers form 1 to 10 using for loop");
  ...
  console.log("Print number from 10 to 60 with gap of 5");
